...
plt.figure(figsize=FIGSIZE)
plt.plot(x_vals, f_vals, label='Original function', linewidth=LINEWIDTH)
plt.plot(x_vals, neutral_vals, label=f'RS Smoothed ($\mu$={sigma})', linestyle='--', linewidth=LINEWIDTH)
plt.plot(x_vals, rs_vals, label=f'LSE Smoothed ($\mu$={sigma}, $\lambda$=0.1)', linestyle='--', linewidth=LINEWIDTH)
